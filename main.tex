...
The tetrahedral test box being a closed box system, it will have an impact on the speaker's behavior. Closed box can be approximated as an additional  stiffness on the speaker's equivalent network, due to the springiness of the air volume trapped in the box. This effect is mostly present in low frequency, as shown in figure \ref{fig:Load_Compa}: the box creates a "bass boost" effect. \\
...
%Correcting this effect can be done by considering a simple acoustic load added to the transducer's equivalent network. 
