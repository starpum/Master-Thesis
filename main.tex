...
By scanning on 2 hemispherical surfaces in front of the baffle, and performing the measurement in half-space, the acoustic shortcut and the diffractions generated by the edges can be separated from the transfer function of the speaker \cite{pres, aeshs}. This method is called field separation, and allows to isolate the speaker's SPL response from any other components. 

\todo[inline]{donner plus de détails sur la séparation}
...
However, the Near-Field being much more complex than the Far Field, holographic processing is required to extrapolate the Far Field data. The complete process will be described succinctly here, and can be found in details in the AES publication \textit{Holographic nearfield measurements of loudspeaker directivity} \citep[][sect.~3]{aeshs}.\\
...
\todo[inline, color=red!40]{Ajouter des équations pour le principe de la measure.}
...
\todo[inline, color=green!40]{Yeah c'est mieux là}
...
\todo[inline, color=red!40]{Make measurement for 90deg rotated speaker and see of sym factors are changed} 

\missingfigure{Measurement of 90deg rotated driver}
...
Now that the theory is expressed, this assumptions needs to be verified. To do so, the impedance of the driver and the displacement transfer function of the driver's membrane have been measured on the 10 cm woofer by using the Klippel system, coupled with a laser for the displacement. \\
