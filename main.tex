...
\todo[inline, color=green!40]{quote Chuan for the measurements}
...
\begin{minipage}{0.5\textwidth}	% Dual plane sym - text
	...
	$R_{m}$ represents a complex symmetry parameter, expressed in equation \ref{eq:Rm} \citep{aeshs} where $\phi _{s}$ is the symmetry axis; and $m$ the suborder of the coefficient under study. \\
...
This symmetry can be between the left and right side of the DUT, as presented in figure \ref{fig:singplsym}; but also between the top and bottom of the DUT, shifting the symmetry plane by 90°.
...
\subsection{Application of the symmetry}
