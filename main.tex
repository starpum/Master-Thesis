...
\subsection[Equations for symmetry condition on complex coefficients of the spherical wave expansion]{Equations for symmetry condition on complex coefficients of the\\ spherical wave expansion}
\label{chap:sym}
...
Once the coefficients have been estimated, the symmetry factor S can be estimated,  estimating the ratio of coefficients satisfying the symmetry condition by the total coefficients. For rotational symmetry, $S_{rs}$ is given by equation \ref{eq:Srs} \cite{aeshs}.
...
After calculating the symmetry factors, it is possible to compare them to different thresholds, the user is informed that the DUT may present certain types of symmetry that could be used to perform a faster full measurement.
