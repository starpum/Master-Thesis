...
\todo[inline, color=red!40]{ change text} 
...
Figure \ref{fig:eq_circ} represents the simplified equivalent circuit of the driver in the box.
...
\begin{center}
    ...
    \captionsetup{hypcap=false}
    \captionof{figure}{Studio monitor, Radiated Powers: zoom on crossover frequency}
